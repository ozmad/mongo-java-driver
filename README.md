...
It was created as a (hopefully) temproary bypass for that dots "bug/improvement": https://jira.mongodb.org/browse/JAVA-2810
Note that fields that contains dots are problematic when used as part of a query
